...
const ministries = [
  ...
  },
  {
    ...
    desc: '[DESCRIÇÃO PENDENTE] — Grupos de estudo e comunhão.',
  ...
  {
    title: 'Recepção',
    desc: '[DESCRIÇÃO PENDENTE] — Equipe de acolhimento e boas-vindas.',
    img: '/images/church-seats.jpg',
    gradient: 'from-[var(--blue)]/10 to-[var(--accent)]/10',
    border: 'border-[var(--blue)]/15',
  },
  {
    title: 'Oração',
    desc: '[DESCRIÇÃO PENDENTE] — Intercessão e sala de oração.',
    img: '/images/worship-hands.jpg',
    gradient: 'from-[var(--purple)]/15 to-[var(--accent)]/10',
    border: 'border-[var(--purple)]/15',
  },
  {
    title: 'Fundamentos',
    desc: '[DESCRIÇÃO PENDENTE] — Curso de crescimento espiritual.',
    img: '/images/church-interior.jpg',
    gradient: 'from-[var(--accent)]/15 to-[var(--purple)]/10',
    border: 'border-[var(--accent)]/15',
  },
  {
    title: 'Voluntariado',
    desc: '[DESCRIÇÃO PENDENTE] — Áreas para servir na CASA.',
    img: '/images/worship-crowd.jpg',
    gradient: 'from-[var(--blue)]/10 to-[var(--accent)]/10',
    border: 'border-[var(--accent)]/15',
  },
